...
1. Download the pretrained model [here](gpcv.whu.edu.cn/member/ZhangTao/model.zip) or [Baiduyun](https://pan.baidu.com/s/1EgEmSFXLVe7dKpqeBG9G3g)(password is `e2ec`).
...
1. Install the Boundary IOU API according [boundary iou](https://github.com/bowenc0221/boundary-iou-api).
